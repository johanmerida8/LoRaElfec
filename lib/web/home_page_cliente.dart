...
class homePageClienteWeb extends StatefulWidget {
  ...
  homePageClienteWeb({required this.nombre});

  @override
  _homePageClienteWebState createState() => _homePageClienteWebState();
}

class _homePageClienteWebState extends State<homePageClienteWeb> {
