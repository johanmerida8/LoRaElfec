...
class homePageAdminWeb extends StatefulWidget {
  ...
  homePageAdminWeb({required this.nombre});
            ...
            appBar: AppBar(
              ...
              title: Row(
                children: [
                  ...
                  /* GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => InsertSensorPage()));
                    },
                    child: TabsWeb("Pruebas Sensor"),
                  ),
                  Spacer(), */
                  /* GestureDetector(
                    onTap: ()  {
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => InsertFacturaPage()));
                    },
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => insertImportePage()));
                    },
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => InsertCategoriaPage()));
                    },
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Sans(
                              ...
                              15.0),
                          Sans("CASA MATRIZ", 15),
                          Sans("Av.Heroinas o-686-casilla 89", 15.0),
                          Sans("Telf.: 4200125-Fax: 4259427", 15.0),
                          Sans("Empresa de Servicios", 15.0),
                          Sans("Cochabamba-Bolivia", 15.0),
                        ],
                      ),
                    ],
                  ),
